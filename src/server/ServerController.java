...
/**
 * Grafiskt anv√§ndargr√§nssnitt f√∂r servern.
 */
public class ServerController {
	...
	/**
	 * Skapar ett grafiskt anv√§ndargr√§nssnitt f√∂r servern.
	...
	public ServerController (ServerConnection server) {
		...
		//Krav 05: Om servern st‰ngs ner sÂ raderas alla skapade anv‰ndare, bˆr finnas sparfunktion
		//Det sparas om man trycker close server, fixa sÂ att den sparar pÂ default-close-operation
