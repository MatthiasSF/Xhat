...
public class MainController {
	...
	private DefaultListModel<JLabel> groupsModel = new DefaultListModel<>(); //M̴ste synkroniseras
	private DefaultListModel<JLabel> contactsModel = new DefaultListModel<>();//M̴ste synkroniseras
